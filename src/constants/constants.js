export const projects = [
  ...
  {
    title: 'CryptoMania',
    description:"Live trackingofvariouscryptocurrencies.",
    image: '/images/7.png',
...
export const blogs = [
  {
    title: 'How to add an existing project to your Github repo.',
    source: 'https://hm-blog.hashnode.dev/how-to-add-existing-project-to-a-github-repository',
    id: 0,
  }
